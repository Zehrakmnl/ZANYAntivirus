...
def fscan(path):
    rules = yara.compile('/home/zehra/Desktop/yaralaaaaarrr/virus/virus.yar') # windowsta değiştirilecek untuma!!
...
def scan():
    def scan(path):
        rules = yara.compile('/home/zehra/Desktop/yaralaaaaarrr/virus/virus.yar')
        filePaths = []
        target = '/home/zehra/Desktop/virus.text'
                    ...
                    for mat in matches:                        
                        for string in mat.strings:  
                            if string[2].decode() in file:
                                ...
                                for rule in matches:
                                    print(mat,rule.strings," => ",{filePath})
                                    break
